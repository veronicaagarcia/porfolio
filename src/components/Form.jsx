...
function Form() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      toast.error(
        'Hubo un error al enviar el mensaje. Por favor, intente nuevamente en unos minutos o contácteme por otro medio.'
      );
    }
  };

  return (
    <div className="py-1 px-0 md:px-2 h-72 bg-secondary-light dark:bg-secondary-dark rounded-lg w-full mx-auto md:w-4/5 lg:w-3/4 xl:w-2/3 hover:opacity-90 hover:shadow-2xl shadow-black opacity-85 transition-all duration-300">
      <form
